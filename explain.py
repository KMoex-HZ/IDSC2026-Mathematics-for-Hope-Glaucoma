...
def visualize_gradcam(img_path, model_path='best_model.pth'):
    ...
    print("True Grad-CAM visualization successfully saved!")

if __name__ == '__main__':
    test_image = "data/raw/hillel-yaffe-glaucoma-dataset-hygd-a-gold-standard-annotated-fundus-dataset-for-glaucoma-detection-1.0.0/Images/12_1.jpg"
